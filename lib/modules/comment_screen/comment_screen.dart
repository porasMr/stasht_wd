...
class CommentsState extends State<Comments> implements ApiCallback {
  ...
  void initState() {
    ...
    EasyLoading.show();
    ApiCall.getComments(
        api: ApiUrl.getComments +
            "?memory_id=${widget.memoryId}&image_id=${widget.imageId}",
        callack: this);
  }
                                                              ...
                                                              children: [
                                                                ...
                                                                Container(
                                                                  child: Text(
                                                                    CommonWidgets
                                                                        .formatTimeAgo(
                                                                            DateTime.parse(commentData![index].createdAt!)),
                                                                    style: const TextStyle(
                                                                        fontSize:
                                                                            11.0,
                                                                        fontStyle:
                          ...
                          Expanded(
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    width: 1,
                                    color: const Color.fromARGB(255, 52, 9,
                                        9)), // Corrected from 'height' to 'width'
                              ),
