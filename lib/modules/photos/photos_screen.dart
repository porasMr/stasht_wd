...
List<Future<Uint8List?>> future=[];
  ...
  void initState() {
    ...
    PrefUtils.instance.getUserFromPrefs().then((value) {
      ...
      for (int i = 0; i < widget.photosList.length; i++) {
            ...
            future.add(widget.photosList[i].assetEntity.thumbnailDataWithSize(ThumbnailSize(300, 300)));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: commonAppbar(context, selectedIndex == 0 ? 'Memories' :"Media"),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: selectedIndex == 1
                              ? AppColors.textfieldFillColor
                              : Colors.white),
                      child: Image.asset("assets/images/image.png", height: 32),
                    ),
                    Text(
                      "MEDIA",
                      style: appTextStyle(
